...
if not utils.BITCOIN_ONLY:
    ...
    BeamGetPublicKey = 905  # type: Literal[905]
    BeamGetOwnerKey = 907  # type: Literal[907]
    BeamOwnerKey = 908  # type: Literal[908]
    BeamGenerateKey = 909  # type: Literal[909]
    BeamGenerateNonce = 910  # type: Literal[910]
    BeamECCPoint = 911  # type: Literal[911]
    BeamGenerateRangeproof = 912  # type: Literal[912]
    BeamRangeproofData = 913  # type: Literal[913]
    BeamSignTransaction = 914  # type: Literal[914]
    BeamSignedTransaction = 915  # type: Literal[915]
    BeamGetNoncePublic = 916  # type: Literal[916]
    BeamSignTransactionSend = 917  # type: Literal[917]
    BeamSignTransactionSendResult = 918  # type: Literal[918]
    BeamSignTransactionReceive = 919  # type: Literal[919]
